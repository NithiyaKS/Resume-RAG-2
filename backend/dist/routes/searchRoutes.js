...
const vectorSearchController_1 = require("../controllers/vectorSearchController");
const hybridSearchController_1 = require("../controllers/hybridSearchController");
const rankingController_1 = require("../controllers/rankingController");
const summarizationController_1 = require("../controllers/summarizationController");
 ...
 * }
 */
router.post('/bm25', searchController_1.bm25Search);
/**
 ...
 * }
 */
router.post('/bm25/advanced', searchController_1.advancedBM25Search);
/**
 * GET /v1/search/stats
 ...
 */
router.post('/init', searchController_1.initializeSearchIndexes);
/**
 ...
 * }
 */
router.post('/vector', vectorSearchController_1.vectorSearch);
/**
 ...
 * - 0.0: No similarity
 */
router.post('/vector/advanced', vectorSearchController_1.advancedVectorSearch);
/**
 ...
 * }
 */
router.get('/vector/stats', vectorSearchController_1.getVectorSearchStats);
/**
 ...
 * }
 */
router.post('/hybrid', hybridSearchController_1.hybridSearch);
/**
 ...
 */
router.post('/hybrid/advanced', hybridSearchController_1.advancedHybridSearch);
/**
 ...
 * }
 */
router.get('/hybrid/stats', hybridSearchController_1.getHybridSearchStats);
/**
 ...
 * }
 */
router.get('/hybrid/weights/:intent', hybridSearchController_1.getRecommendedWeights);
/**
 ...
 * }
 */
router.post('/rerank', rankingController_1.rerankCandidates);
/**
 ...
 * }
 */
router.get('/rerank/status', rankingController_1.getRerankStatus);
/**
 ...
 * }
 */
router.post('/summarize', summarizationController_1.summarizeCandidate);
/**
 ...
 * }
 */
router.post('/summarize/batch', summarizationController_1.batchSummarizeCandidates);
/**
 ...
 * }
 */
router.get('/summarize/status', summarizationController_1.getSummarizationStatus);
