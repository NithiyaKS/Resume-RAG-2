 ...
 */
router.post('/store-and-embed', embeddingController_1.storeAndEmbed);
/**
 ...
 */
router.post('/store-and-embed-async', embeddingController_1.storeAndEmbedAsync);
/**
 * GET /api/store-embed/batch-status/:jobId
 * Check status of async batch processing job
 */
router.get('/batch-status/:jobId', embeddingController_1.getBatchStatus);
/**
 * GET /api/store-embed/status
 * Get current embedding status and statistics
 */
router.get('/status', embeddingController_1.getEmbeddingStatus);
/**
 * GET /api/store-embed/:id
 * Get resume with embeddings by ID
 */
router.get('/:id', embeddingController_1.getResumeWithEmbeddings);
/**
 * DELETE /api/store-embed/:id
 * Delete resume by ID
 */
router.delete('/:id', embeddingController_1.deleteResume);
