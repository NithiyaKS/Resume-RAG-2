...
exports.batchSummarizeCandidates = batchSummarizeCandidates;
exports.getSummarizationStatus = getSummarizationStatus;
const llmSummarizationService_1 = require("../services/llmSummarizationService");
const logger_1 = require("../utils/logger");
const logger = new logger_1.Logger('SummarizationController');
const llmSummarizationService = new llmSummarizationService_1.LLMSummarizationService();
/**
 ...
 * }
 */
async function summarizeCandidate(req, res) {
    try {
        ...
        logger.info(`Summarization request: query="${query}", candidate=${candidate.name}, style=${style}, maxTokens=${maxTokens}`);
        // Create config
        const config = {
            style: style,
            maxTokens,
 ...
 * }
 */
async function batchSummarizeCandidates(req, res) {
    try {
 ...
 * }
 */
async function getSummarizationStatus(req, res) {
    try {
